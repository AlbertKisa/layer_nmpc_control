...
def update_smooth(frame):
    ...
    if frame == num_frames_interpolated - 1:
        ...
        # Leader 跟 Follower1 連線
        ax.plot([P_l_traj[0, -1], P_f1_end[0]], [P_l_traj[1, -1], P_f1_end[1]], [P_l_traj[2, -1], P_f1_end[2]], color='black')
        # Leader 跟 Follower2 連線
        ax.plot([P_l_traj[0, -1], P_f2_end[0]], [P_l_traj[1, -1], P_f2_end[1]], [P_l_traj[2, -1], P_f2_end[2]], color='black')
        # Follower1 跟 Follower3 連線
        ax.plot([P_f1_end[0], P_f3_end[0]], [P_f1_end[1], P_f3_end[1]], [P_f1_end[2], P_f3_end[2]], color='black')
        # Follower2 跟 Follower4 連線
        ax.plot([P_f2_end[0], P_f4_end[0]], [P_f2_end[1], P_f4_end[1]], [P_f2_end[2], P_f4_end[2]], color='black')
        # Follower3 跟 Follower4 連線
        ax.plot([P_f3_end[0], P_f4_end[0]], [P_f3_end[1], P_f4_end[1]], [P_f3_end[2], P_f4_end[2]], color='black')
