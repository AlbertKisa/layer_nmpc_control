...
# 创建一个以当前时间命名的文件夹
folder_path = f"./results/{time_str}"  # 假设文件夹创建在当前目录下
...
# def results_write_to_csv(P_l_traj_interpolated=None, P_f1_traj_interpolated, P_f2_traj_interpolated, num_frames_interpolated, traj_csv_path,
#                          P_l_start, P_l_goal, P_f1_start, P_f2_start, ):
def results_write_to_csv(**kwargs):
    if kwargs["traj_csv_path"]:
        leader_pose = {
...
results_write_to_csv(a=P_l_traj_interpolated, b=P_f1_traj_interpolated, c=P_f2_traj_interpolated, d=num_frames_interpolated, traj_csv_path=traj_csv_path)
# #记录csv
# leader_pose = {
#     "leader_x": P_l_traj_interpolated[0, :num_frames_interpolated],
#     "leader_y": P_l_traj_interpolated[1, :num_frames_interpolated],
