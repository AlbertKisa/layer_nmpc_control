...
# 定義向量以形成編隊
d1 = all_points[1] - all_points[0]
d2 = all_points[2] - all_points[0]
d3 = all_points[3] - all_points[0]
d4 = all_points[4] - all_points[0]
...
dis_to_goal_list.insert(
    0, ["leader", "follow1", "follow2", "follow3", "follow4", "follow5"])
...
def init():
    ...
    return leader_line, f1_line, f2_line, f3_line, f4_line, f5_line
...
def update_smooth(frame):
    ...
    if frame == num_frames_interpolated - 1:
        ...
        # plot f3->f5
        ax.plot([P_f3_end[0], P_f5_end[0]], [P_f3_end[1], P_f5_end[1]],
                [P_f3_end[2], P_f5_end[2]],
                color='black')
        ...
        # plot f4->f3->f5
        ax.plot([P_f4_end[0], P_f3_end[0]], [P_f4_end[1], P_f3_end[1]],
                [P_f4_end[2], P_f3_end[2]],
                color='black')
